...
class NotebookViewer:
    ...
    def _initialize_assets(self, forex_symbol: str = "EURCHF=X"):
        ...
        self.forex_daily = MarketAsset(forex_symbol, provider=forex_daily_provider)
    ...
    def render_btc_daily_rsi(self):
        ...
        fig = ChartPlotter.plot_indicator_with_signals(
    ...
    def render_btc_daily_combined(self):
        ...
        fig = ChartPlotter.plot_candlestick_with_signals(
            df=daily_df,
    ...
    def render_btc_multi_timeframe(self):
        ...
        fig = ChartPlotter.plot_multiple_indicators(
            data=data,
    ...
    def run(self):
        ...
        with st.sidebar:
            ...
            refresh_data = st.toggle("Atualizar dados ao renderizar", value=False)

            st.subheader("💱 FOREX")
            forex_symbol = st.text_input("FOREX symbol (Yahoo)", value="EURCHF=X")
        ...
        if selected_charts and render_button:
            ...
            if refresh_data:
                self._initialize_assets(forex_symbol=forex_symbol)
