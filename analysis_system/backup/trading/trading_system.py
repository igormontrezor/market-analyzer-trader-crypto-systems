...
with tab_rsi:
    ...
    st.markdown("""
    <div class="rule-card">
        <div class="rule-title"><span class="rule-badge">REGRA PRINCIPAL</span> Peso maior para suporte/resistência</div>
        <div class="rule-body">
            Quando o RSI toca o <b>fundo do canal de tendência</b> (no semanal/mensal), aguarde o Stochastic RSI confirmar nos timeframes menores. Se o RSI romper o canal → entrar na tendência.<br><br>
            <b style="color: #f85149;">Nunca operar fora do canal RSI. Nunca operar contra a tendência.</b>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    with c2: st.markdown('<div class="tf-card"><div class="tf-label">W1</div><div class="tf-val" style="color:#EF9F27">≈ 38</div><div class="tf-desc">pullback no fundo</div></div>', unsafe_allow_html=True)
    with c3: st.markdown('<div class="tf-card"><div class="tf-label">D1</div><div class="tf-val" style="color:#EF9F27">≈ 32</div><div class="tf-desc">fundo do canal</div></div>', unsafe_allow_html=True)
    with c4: st.markdown('<div class="tf-card"><div class="tf-label">H4</div><div class="tf-val" style="color:#3B8BD4">↑ virando</div><div class="tf-desc">execução</div></div>', unsafe_allow_html=True)
...
with tab_stoch:
    ...
    <div class="rule-card" style="margin-top: 15px;">
        ...
        <div class="rule-body">
            <b>Compra:</b> Tendência semanal de alta → esperar Stoch RSI no 4H/D1 no <i>fundo</i> (oversold) → entrada quando virar para cima.<br><br>
            <b>Venda:</b> Tendência semanal de baixa → esperar Stoch RSI no 4H/D1 no <i>topo</i> (overbought) → entrada quando virar para baixo.<br><br>
            O Stoch RSI está sempre <b>na direção contrária à tendência</b> no TF menor — isso é o pullback confirmado.
        </div>
    </div>
    """, unsafe_allow_html=True)
