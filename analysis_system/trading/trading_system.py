...
def _rsi_near_bottom(row, near_pct=0.03):
...
def _rsi_near_top(row, near_pct=0.03):
...
def check_signals(data, symbol, athena_levels):
    ...
    NEAR_TF  = 0.015   # pontos RSI — diario e 4H
    NEAR_W1_MN = 0.020 # pontos RSI — semanal e mensal
